...
const PerfectTeam = () => {
    return (
        <div className='w-[1200px] h-[725px] flex gap-12'>
            <div className='w-[360px] ml-6 h-[300px] bg-[#C4C4C4]'>
                <img src="https://plus.unsplash.com/premium_photo-1675884829500-72e4441e333b?q=80&w=1588&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
            </div>
