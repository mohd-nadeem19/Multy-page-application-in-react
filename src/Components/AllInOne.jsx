        ...
        <div className='flex gap-8 mt-32 w-full'>
            <div className='w-[700px] h-[550px] flex justify-end items-center'>
                <img
                    ...
                    src="https://cdn.pixabay.com/photo/2023/12/30/07/31/interior-design-8477524_640.jpg"
                    alt="Home Design"
                />
            </div>
            ...
            <div className='w-[650px] h-[500px] mt-10 '>
                <div className='relative'>
                    ...
                    <div className='absolute top-10 left-0 space-y-4 '>
                        ...
                        <h1 className='font-poppins font-bold text-4xl w-[400px] text-[#1B1717]'>ALL IN ONE HOME INTERIOR DESIGN</h1>
                    </div>
