...
const TeamWorking = () => {
    return (
        <div className='flex gap-8 mt-32 w-full'>
            <div className='w-[700px] h-[550px] flex justify-end items-center'>
                <img
                    className='w-full h-full object-cover'
                    src="https://cdn.pixabay.com/photo/2019/09/09/07/17/race-4462878_640.jpg"
                    alt="Home Design"
                />
            </div>
            ...
            <div className='w-[650px] h-[500px] mt-10 '>
                <div className='relative'>
                    ...
                    <div className='absolute top-10 left-0 space-y-4 '>
                        <span className='font-poppins font-bold text-lg text-[#757575]'>Team Working</span>
                        <h1 className='font-poppins font-bold text-4xl w-[400px] text-[#1B1717]'>LETS SEE OUR PERFECT TEAM WORKER</h1>
                    </div>
